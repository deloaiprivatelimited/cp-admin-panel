...
export const addMinimalCodingQuestion = async (payload,id) => {
  // payload: { title: string, short_description?: string, topic?: string }
  const { data } = await privateAxios.post(`/course-coding-questions/minimal/${id}`, payload);
...
export const fetchMinimalQuestions = async ({
  ...
  const { data } = await privateAxios.get(`/course-coding-questions/minimal`, { params });
...
export const getMinimalQuestion = async (id) => {
  const { data } = await privateAxios.get(`/course-coding-questions/minimal/${id}`);
...
export const getQuestionForm = async (questionId) => {
  ...
  const { data } = await privateAxios.get(`/course-coding-questions/form/${questionId}`);
...
export const saveQuestionForm = async (questionId, payload = {}) => {
  ...
  // }
  const { data } = await privateAxios.post(`/course-coding-questions/form/${questionId}`, payload);
...
export const fetchTestcaseGroups = async (questionId) => {
  if (!questionId) throw new Error("questionId is required");
  const { data } = await privateAxios.get(`/course-coding-questions/${questionId}/testcase-groups`);
...
export const createTestcaseGroup = async (questionId, payload = {}) => {
  if (!questionId) throw new Error("questionId is required");
  const { data } = await privateAxios.post(`/course-coding-questions/${questionId}/testcase-groups`, payload);
...
export const updateTestcaseGroup = async (questionId, payload = {}) => {
  ...
  const { data } = await privateAxios.put(`/course-coding-questions/${questionId}/testcase-groups`, payload);
...
export const deleteTestcaseGroup = async (groupId) => {
  ...
  const { data } = await privateAxios.delete(`/course-coding-questions/testcase-group/${groupId}`);
 ...
 * GET /course-coding-questions/form/:questionId/boilerplates
 * Returns: { id: "<questionId>", predefined_boilerplates: { python: "...", cpp: "..." } }
 */
export const getPredefinedBoilerplates = async (questionId) => {
  if (!questionId) throw new Error("questionId is required");
  const { data } = await privateAxios.get(`/course-coding-questions/form/${questionId}/boilerplates`);
 ...
 * POST /course-coding-questions/form/:questionId/boilerplates
 *
 * Usage:
...
export const upsertPredefinedBoilerplates = async (questionId, payload = {}) => {
  ...
  const { data } = await privateAxios.post(`/course-coding-questions/form/${questionId}/boilerplates`, payload);
 ...
 * GET /course-coding-questions/form/:questionId/solution
 * Returns: { id: "<questionId>", solution_code: { python: "...", cpp: "..." } }
 */
export const getSolutionCode = async (questionId) => {
  if (!questionId) throw new Error("questionId is required");
  const { data } = await privateAxios.get(`/course-coding-questions/form/${questionId}/solution`);
 ...
 * POST /course-coding-questions/form/:questionId/solution
 *
 * Usage:
...
export const upsertSolutionCode = async (questionId, payload = {}) => {
  if (!questionId) throw new Error("questionId is required");
  if (!payload || typeof payload !== "object") throw new Error("payload is required");
  const { data } = await privateAxios.post(`/course-coding-questions/form/${questionId}/solution`, payload);
 ...
 * DELETE /course-coding-questions/:questionId
 *
 * Returns backend response `data.data` if successful.
 */
export const deleteCodingQuestion = async (questionId) => {
  if (!questionId) throw new Error("questionId is required");
  const { data } = await privateAxios.delete(`/course-coding-questions/${questionId}`);
